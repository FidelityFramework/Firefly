...
- `-nostdlib`: No standard library - FNCS provides everything
...
| Region | Size | Usage |
|--------|------|-------|
| Code | ~2-4 MB | Application, FNCS, LVGL |
...
// Platform.Bindings.writeBytes via FNCS - Alex emits write syscall
```
